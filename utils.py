...
def sort_tokens_by_abs_correlation(
    doc_ids, acts, feature_idx, model_name="roneneldan/TinyStories-33M"
):
    """
...
def get_n_most_correlated_tokens(
    doc_ids, acts, feature_idx, n=32, model_name="roneneldan/TinyStories-33M"
):
    """
...
def plot_mse_loss(doc_ids, acts, feature_idx, max_tokens):
    ...
    mse_losses = [
        compute_mse_loss_only(doc_ids, acts, feature_idx, toks[:n])
        for n in tqdm(token_range, desc="Computing MSE Loss")
    ]
